INSERT IGNORE INTO membership_card (id, card_number, issue_date, expiry_date)
VALUES (1, 'X8JZ-2M4Q-9WTP', '2023-01-10', '2026-01-10'),
       (2, 'L3YV-7A6F-1KBD', '2023-03-15', '2026-03-15');

INSERT IGNORE INTO library_member (id, name, email, membership_date, membership_card_id)
VALUES (1, 'Alice Johnson', 'alice@example.com', '2023-01-10', 1),
       (2, 'Bob Smith', 'bob@example.com', '2023-03-15', 2);

INSERT IGNORE INTO author (id, name, biography)
...
INSERT IGNORE INTO book (id, title, isbn, publication_year)
...
INSERT IGNORE INTO borrow_record (id, borrow_date, return_date, library_member_id, book_id)
